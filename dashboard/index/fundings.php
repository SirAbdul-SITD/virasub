                  ...
                  <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                    <g id="Icon" transform="translate(27.000000, 15.000000)">
                      <g id="Mask" transform="translate(0.000000, 8.000000)">
                        ...
                        <use fill="#14a39a" xlink:href="#path-1"></use>
                        <g id="Path-3" mask="url(#mask-2)">
                          <use fill="#14a39a" xlink:href="#path-3"></use>
                          <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-3"></use>
                        </g>
                        <g id="Path-4" mask="url(#mask-2)">
                          <use fill="#14a39a" xlink:href="#path-4"></use>
                          <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-4"></use>
                        </g>
                      </g>
                      <g id="Triangle"
                        transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
                        <use fill="#14a39a" xlink:href="#path-5"></use>
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <span style="display: flex; justify-content: space-between; align-items: center;">
                <h5 class="card-header">Wallet Funding History</h5>
                <div class="dropdown" style="display: flex; align-items: center; padding-right: 5%;">
                  ...
                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                    ...
                    <a class="dropdown-item filter-option" data-filter="Bank Transfer" href="javascript:void(0);">Bank
                      Transfer
                      History</a>
                    <a class="dropdown-item filter-option" data-filter="Bank" href="javascript:void(0);">Bank Deposit
                      History</a>
              ...
              <div class="table-responsive text-nowrap">
                ...
                $query = "SELECT * FROM funding WHERE user = :userEmail ORDER BY `funding`.`date` DESC";
                  ...
                  <tbody class="table-border-bottom-0">
                    <?php foreach ($paginated_data as $transaction): ?>
                      <tr>
                        ...
                        <td>
                          <?= $formattedDateTime = $transaction['status']->format('Y-m-d H:i:s.u');
