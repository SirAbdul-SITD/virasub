...
if (isset($_GET['show_details'])) {
  ...
  if ($transactionDetails) {
    ...
    $_narration = $transactionDetails["narration"];
...
<head>
  ...
  <title>Failed Deposit History | Billzwave</title>
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item active open">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <div data-i18n="History">Deposit</div>
            </a>
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                  ...
                  <div class="modal-content" style="text-align: center">
                    ...
                    <div class="modal-footer" style="min-width: 100%; justify-content: center;">
                      ...
                      <button type="button" class="btn btn-warning" id="" style="min-width:45%"> <i
                          class="bx bx-delete me-1"></i> Fund Wallet</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card">
              <span style="display: flex; justify-content: space-between; align-items: center;">
                <h5 class="card-header">Failed Deposit</h5>
