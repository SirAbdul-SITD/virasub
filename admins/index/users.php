...
if (isset($_GET['show_details'])) {
  ...
  if ($transactionDetails) {
    ...
    $phone_number = $transactionDetails["phone"];
  }
}
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" 
                                href="user.php?user=<?= $transaction['email'] ?>">
                                <i class="bx bx-book-alt me-1"></i> More Info
                              </a>
                              <a class="dropdown-item"
                              href="fund_wallet.php?email=<?= $transaction['email'] ?>">
                                <i class="bx bx-send me-1"></i> Credit User
                              </a>
                            </div>
                          </div>
                        </td>
