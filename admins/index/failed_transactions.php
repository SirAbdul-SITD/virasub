...
<head>
  ...
  <title>Failed Transaction History | Billzwave</title>
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <span style="display: flex; justify-content: space-between; align-items: center;">
                <h5 class="card-header">Failed Transactions</h5>
              ...
              <div class="table-responsive">
                <?php
                $status = "Failed";
                $query = "SELECT * FROM transactions WHERE status = :status ORDER BY `funding`.`date` DESC";
                $stmt = $pdo->prepare($query);
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a class="dropdown-item" id="send">
                                <i class="bx bx-money me-1"></i> Refund
                              </a>
                            </div>
                          </div>
                        </td>
