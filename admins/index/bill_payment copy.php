...
$response = true;
    ...
    if ($response) {
        ...
        $status = 'success';
        $disco = 'kano something something...';
        $requestId = 'request-id89676874268978';
        $amount = '2000';
        $fee = '10';
        $message = 'message';
        $meter_number = '09767467587908';
        $meter_type = 'prepaid';
        $oldBalance = 'oldbal';
        $newBalance = 'newbal';
        $system = 'system';
        $token = '8564w3456478908966345657889';
        $walletVending = 'wallet_vending';
        ...
        if ($status === 'success') {
            ...
            sendErrorEmailToAdmin($message);
            throw new Exception("Couldn't complete your request. Please try again. [err_code: #3323] $response");
        }
