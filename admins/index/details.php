...
<table class="table">
  ...
  <tbody class="table-border-bottom-0">
    <?php foreach ($paginated_data as $transaction): ?>
      <tr>
        <td>
          <?= $row_index + 1; ?> <!-- Use $row_index for continuous numbering -->
        </td>
        <td>
          <?= $transaction['type']; ?>
        </td>
        ...
        <td>
          <div class="dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" class="details" href="?show_details=<?= $transaction['trx_ref'] ?>">
      ...
      <?php $row_index++; // Increment the row index for continuous numbering ?>
    <?php endforeach; ?>
  </tbody>
</table>
