            ...
            <div class="row">
              <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  <li class="nav-item">
                    <a class="nav-link " href="user.php?user=<?= $user_email ?>"><i class="bx bx-link-alt me-1"></i>
                      Account</a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                  ...
                  <?php if ($_type == "Airtime") { ?>
                    <div class="modal fade" id="Airtime_details" tabindex="-1" aria-hidden="true"
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content" style="text-align: center">
                          ...
                          <div class="modal-footer" style="min-width: 100%; justify-content: center;">
                            <button type="button" id="close-model" class="btn btn-outline-secondary"
                  ...
                  <?php if ($_type == "Utility") { ?>
                    <div class="modal fade" id="Utility_details" tabindex="-1" aria-hidden="true"
                      data-bs-backdrop="static" data-bs-keyboard="false">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content" style="text-align: center">
                          <div class="modal-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 order-2 mb-4">
                      <div class="card h-100">
                        ...
                        <div class="card-body">
                          <?php
                          $query = "SELECT * FROM funding WHERE user = :user_email ORDER BY date DESC";
                          $stmt = $pdo->prepare($query);
                              ...
                              echo '<a href="?show_detail=' . $trx_ref . '">
                                ...
                                ($status === "Failed" ? "red" :
                                  ($status === "Pending" ? "gold" : "green")
                                              ...
                                              ' . ($status === "Failed" ? "<span style='color: black'>Failed</span>" :
                                ($status === "Pending" ? "<span style='color: black'>Pending</span>" : "<span style='color: black'>NGN</span>")
                              ) . '
                                          </div>
                                      </div>
                                  </li>
                    ...
                    <div class="col-md-6 col-lg-6 order-2 mb-4">
                      <div class="card h-100">
                        ...
                        <div class="card-body">
                          <?php
                          $query = "SELECT * FROM transactions WHERE user = :user_email ORDER BY date DESC";
                          $stmt = $pdo->prepare($query);
                          $stmt->bindParam(':user_email', $user_email, PDO::PARAM_STR);
                          $stmt->execute();
