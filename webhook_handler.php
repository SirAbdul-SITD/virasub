...
$possibleHeaderNames = ['VERIF-HASH', 'Verif-Hash', 'verif-hash'];
$secretHashFromHeader = null;

foreach ($possibleHeaderNames as $headerName) {
    if (isset($_SERVER[$headerName])) {
        $secretHashFromHeader = $_SERVER[$headerName];
        break;
    }
}
